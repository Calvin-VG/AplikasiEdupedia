...
public class StudyProvisionsAmerikaActivity extends AppCompatActivity {

    TextView study_amerika;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_study_provisions_amerika);

        study_amerika = findViewById(R.id.tv_study_amerika);
    ...
    void studyAmerika(){
        ...
        String URL = "http://"+getString(R.string.ip_server)+":8012/edupedia/america_study_provisions.php";
