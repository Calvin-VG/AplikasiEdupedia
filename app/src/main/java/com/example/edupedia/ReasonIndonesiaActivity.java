...
public class ReasonIndonesiaActivity extends AppCompatActivity {

    TextView reason_indonesia;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_reason_indonesia);

        reason_indonesia = findViewById(R.id.tv_reason_indonesia);

        reasonIndonesia();
    }

    void reasonIndonesia(){
        // ini sialisasi permintaan data
        String URL = "http://"+getString(R.string.ip_server)+":8012/edupedia/indonesia_reason.php";
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < jsArr.length(); i++) {
                                ...
                                reason_indonesia.setText(reason);
                            }
